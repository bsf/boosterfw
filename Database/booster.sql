/******************************************************************************/
/***         Generated by IBExpert 2011.08.15.2 09.12.2011 17:29:16         ***/
/******************************************************************************/
...
CREATE PROCEDURE BFW_INF_EV_SETTING_CHECK (
    NAME_ VARCHAR(50),
...
CREATE PROCEDURE BFW_INF_EV_SETTING_GET (
    NAME_ VARCHAR(50),
    USERNAME_ VARCHAR(50))
RETURNS (
    VALI INTEGER,
...
CREATE PROCEDURE BFW_INF_EV_SETTING_SET (
    NAME_ VARCHAR(50),
    USERNAME_ VARCHAR(50),
    VALI_ INTEGER,
    VALS_ VARCHAR(250),
...
CREATE PROCEDURE BFW_INF_SP_SETTING (
    NAME_ VARCHAR(50))
RETURNS (
    VALI INTEGER,
    VALS VARCHAR(250),
...
CREATE PROCEDURE BFW_INF_SP_SETTING_ (
    NAME_ VARCHAR(50))
RETURNS (
    VALI INTEGER,
    VALS VARCHAR(250),
...
CREATE PROCEDURE BFW_UI_EV_LIST
RETURNS (
    URI VARCHAR(50),
    CLS VARCHAR(50),
...
CREATE PROCEDURE BFW_UTL_SP_STRING_LEN (
...
CREATE PROCEDURE BFW_UTL_SP_STRING_REPLACE (
    STR_IN VARCHAR(1024),
...
CREATE PROCEDURE BFW_UTL_SP_STRING_SUB (
...
ALTER PROCEDURE BFW_INF_EV_SETTING_CHECK (
    NAME_ VARCHAR(50),
    USERNAME_ VARCHAR(50))
RETURNS (
    COMMON_EXISTS INTEGER,
...
ALTER PROCEDURE BFW_INF_EV_SETTING_GET (
    NAME_ VARCHAR(50),
    USERNAME_ VARCHAR(50))
RETURNS (
    VALI INTEGER,
...
ALTER PROCEDURE BFW_INF_EV_SETTING_SET (
    NAME_ VARCHAR(50),
    USERNAME_ VARCHAR(50),
    VALI_ INTEGER,
    VALS_ VARCHAR(250),
...
ALTER PROCEDURE BFW_INF_SP_SETTING (
    NAME_ VARCHAR(50))
RETURNS (
    VALI INTEGER,
    VALS VARCHAR(250),
...
begin
  ...
  begin
    ...
    exception bfw_raise 'Значение параметра ''' || :setting_title || ''' не определено';
  end
...
ALTER PROCEDURE BFW_INF_SP_SETTING_ (
    NAME_ VARCHAR(50))
RETURNS (
    VALI INTEGER,
    VALS VARCHAR(250),
...
ALTER PROCEDURE BFW_UI_EV_LIST
RETURNS (
    URI VARCHAR(50),
    CLS VARCHAR(50),
    ENTITYNAME VARCHAR(50),
...
ALTER PROCEDURE BFW_UTL_SP_STRING_LEN (
    STRG_IN VARCHAR(32765))
RETURNS (
    STRG_LEN SMALLINT)
AS
...
ALTER PROCEDURE BFW_UTL_SP_STRING_REPLACE (
    STR_IN VARCHAR(1024),
    STR_SEARCH VARCHAR(1024),
    STR_REPLACE VARCHAR(1024))
RETURNS (
...
ALTER PROCEDURE BFW_UTL_SP_STRING_SUB (
    STR_IN VARCHAR(32765),
    STR_BEG SMALLINT,
    STR_LEN SMALLINT)
RETURNS (
