/******************************************************************************/
/***          Generated by IBExpert 2012.03.13 11.07.2012 14:35:57          ***/
/******************************************************************************/
...
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('BFW_UI', 'List', 'select i.uri, i.cls, i.entityname, coalesce(i.viewname, c.viewname) viewname,
    ...
    order by g.idx, i.menuidx, i.title', NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, NULL, NULL);
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('BFW_UI', 'Commands', 'select cmd.idx, cmd.* from bfw_ui_cmd cmd where cmd.uri = :uri
union
...
order by 1', NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, NULL, NULL);
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('BFW_UI', 'Styles', 'select * from bfw_ui_styles', NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, NULL, NULL);
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('BFW_META', 'Entities', 'select entityname from bfw_ent', NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, NULL, NULL);
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('BFW_META', 'Fields', 'select * from bfw_ent_fields where entityname = :entityname and viewname = :viewname', NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, NULL, NULL);
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('BFW_META', 'Entity', 'select * from bfw_ent where entityname = :entityname', NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, NULL, NULL);
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('BFW_META', 'View', 'select * from bfw_ent_views where entityname = :entityname and viewname = :viewname', NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, NULL, NULL);
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('BFW_META', 'ViewLinks', 'select * from bfw_ent_view_links where entityname = :entityname and viewname = :viewname', NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, NULL, NULL);
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('BFW_META', 'ViewLinkedFields', 'select * from bfw_ent_view_links  where linked_entityname = :entityname and linked_viewname = :viewname and coalesce(linked_field, '''') <> ''''', NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, NULL, NULL);
