...
begin
  ...
  begin
    ...
    if FButtonAlignment = alLeft then
      ...
      Left := nextPosition - MulDiv(Width, App.Views.ViewStyle.Scale, 100);
  ...
  Result.ScaleBy(App.Views.ViewStyle.Scale, 100);
...
begin
  Result := MulDiv(const_ButtonMargin, App.Views.ViewStyle.Scale, 100);
end;
...
begin
  Result := MulDiv(const_TopMargin, App.Views.ViewStyle.Scale, 100);
end;
